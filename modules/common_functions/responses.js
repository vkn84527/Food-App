...
const sendordervalueResponse = (res, msg, values, status) => {
    return res.json({
        Message: msg,
        Your_Values:values,
        Status: status
...
module.exports = { sendResponse, sendcancelResponse, sendtokencustomerResponse, sendtokenmerchantResponse,sendordervalueResponse }
